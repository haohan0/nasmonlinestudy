...
<div class="container-fluid">
    <div class="row-fluid">
        <form class="form-inline" method="post"
            ...
            <input class="input-xlarge" placeholder="题号..." name="username"
            ...
            <table class="table">
                ...
                <c:forEach items="${pager.list}" var="item">
                    <tr>
                        ...
                        <td>
                            <a href="<%=basePath%>grade/task?cmd=toedit&id=${item.grade}">编辑</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
            ...
            <div class="pagination pagination-right">
                <ul>
                    ...
                    <li>
                        ...
                        <c:if test="${!fp}">
                            <a href="<%=basePath%>sys/grade?cmd=list&index=${pager.pagectrl.currentindex-1}">上一页</a>
                        </c:if>
                    </li>
                    ...
                    <c:forEach begin="${pager.pagectrl.minpage}" step="1" end="${pager.pagectrl.maxpage}" var="index">
                        <li>
                            ...
                            <c:if test="${!t}">
                                <a href="<%=basePath%>sys/grade?cmd=list&index=${index}">${index}</a>
                            </c:if>
                        </li>
                    </c:forEach>
                    ...
                    <li>
                        ...
                        <c:if test="${!fp}">
                            <a href="<%=basePath%>sys/grade?cmd=list&index=${pager.pagectrl.currentindex+1}">下一页</a>
                        </c:if>
                    </li>
                </ul>
            </div>
