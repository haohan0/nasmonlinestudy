...
public class UserDao implements IUserDao {
	...
	public Pager<Sysuser> usertasklist(Sysuser user, PageControl pc) {
		String sql = "SELECT A.username,A.usertruename,B.taskid,B.workstate FROM sysuser A INNER JOIN workfile B ON A.username = B.username WHERE A.username=?";
		Pager<Sysuser> pager = null;
		String userid="userid";
		pager = DBUnitHelper.execlist(sql, pc, Sysuser.class,userid, user.getUsername());
		return pager;
