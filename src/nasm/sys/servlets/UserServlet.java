...
import nasm.model.*;
import nasm.sys.services.impl.*;
import nasm.sys.services.interfaces.*;
...
public class UserServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		}else if (cmd.equals("gradelist")){
			gradelist(request,response);
		}else if (cmd.equals("usertasklist")){
			usertasklist(request,response);
		}
	}
	 ...
	 * @throws ServletException
	 */
	private void stulist(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		String sname = request.getParameter("sname");
		Sysuser user = new Sysuser();
		if(sname!=null && !sname.equals("")){
		...
		Pager<Sysuser> pager = service.userlist(user, pc);
		request.setAttribute("pager", pager);
		request.getRequestDispatcher("/sys/student/list.jsp").forward(request, response);
	 ...
	 * @throws ServletException
	 */
	private void gradelist(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		...
		Pager<Sysuser> pager = service.userlist(user,pc);
		Pager<Grade> pager2 = gradeService.userlist(grade,pc);
		request.setAttribute("user",user);
		request.setAttribute("pager",pager);
		request.setAttribute("pager2", pager2);

		request.getRequestDispatcher("/sys/student/gradelist.jsp").forward(request, response);
	 ...
	 * @param response
	 */
	private void usertasklist(HttpServletRequest request, HttpServletResponse response)
		throws ServletException,IOException{
		// TODO Auto-generated method stub
		...
		Pager<Sysuser> pager = service.usertasklist(user, pc);
		request.setAttribute("pager", pager);
